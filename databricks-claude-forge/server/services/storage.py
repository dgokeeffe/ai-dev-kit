...
class ProjectStorage:
  ...
  async def get_all(self, limit: int = 50, offset: int = 0) -> list[Project]:
...
class ConversationStorage:
  ...
  async def get_all(self, limit: int = 50, offset: int = 0) -> list[Conversation]:
  ...
  async def update_workspace_folder(
    self, conversation_id: str, workspace_folder: str | None
  ) -> bool:
...
def get_execution_storage(
  user_email: str, project_id: str, conversation_id: str
) -> ExecutionStorage:
